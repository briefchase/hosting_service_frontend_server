...
import { pushBackHandler, replaceBackHandler } from '/js/scripts/back.js';
import { fetchMachines } from '/js/scripts/api.js';
import { prompt, clearPromptStack } from '/js/pages/prompt.js';
import { establishWebSocketConnection } from '/js/scripts/socket.js';
import { returnFromTerminal, handleTerminalMessage } from '/js/pages/terminal.js';
