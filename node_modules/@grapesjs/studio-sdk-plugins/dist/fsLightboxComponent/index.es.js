const N = "app.grapesjs.com", S = "app-stage.grapesjs.com", U = "app2.grapesjs.com", H = "app-stage2.grapesjs.com", V = [
  N,
  U,
  S,
  H,
  ...
  isStage: n,
  isPlatform: c
}) => `${e ? "" : `https://${n ? S : N}`}/${c ? "platform-api" : "api"}`, Z = () => {
  const e = W() && window.location.hostname;
  return !!e && (V.includes(e) || V.some((n) => e.endsWith(n)));
};
async function q({
  path: e,
  baseApiUrl: n,
  ...
  const g = `${n || K({ isDev: !1, isStage: !1 })}${e}`, u = {
    method: c,
    headers: {
...
async function X({
  ...
  const u = (s) => {
    ...
    if (!(I || s.license) || p)
      ...
      const O = m[n], t = m[T];
      O > t && u({ pluginRequiredPlan: n, licensePlan: T });
    }
  };
  e.Commands.has(j.settings) && (g = e.runCommand(j.settings), h = (g == null ? void 0 : g.baseUrl) || "");
  const v = (s) => {
    r == null || r(s), s && y(s);
  };
  if (!g) {
    e.onReady(async () => {
      if (!Z())
        if (l) {
          const s = await Q({ licenseKey: l, pluginName: c, baseApiUrl: h });
          v(s);
        } else
...
async function Q(e) {
  const { licenseKey: n, pluginName: c, baseApiUrl: l } = e;
  try {
    return (await q({
      baseApiUrl: l,
      path: `/sdk/${n || "na"}`,
...
const C = "gjs-plg-", ee = "fsLightboxComponent", te = w.startup, D = "data-fslightbox", G = "data-type", oe = "fslightbox-open", A = "fslightbox", P = {
  ...
  const { Blocks: c, Components: l } = e, r = "Lightbox", f = `${C}${A}`, h = {
    ...
    const o = this, a = "data-fslightbox", i = window, b = () => {
      var B;
      const d = i.refreshFsLightbox;
      d == null || d();
      const k = o.getAttribute(a);
      if ((B = i.fsLightboxInstances) == null || B[k], !i._isEditor) return;
      Array.from(document.querySelectorAll(`[${a}]`)).forEach((L) => {
        const x = L.onclick;
        L.onclick = function(_) {
          _.preventDefault();
          const $ = L;
          !$.__skipLb && (x == null || x(_)), $.__skipLb = !0;
        };
      });
    };
  ...
  l.addType(A, {
    ...
    model: {
      defaults: {
        ...
        traits: [
          ...
          },
          {
            ...
            command(t, o) {
              var i;
              const a = (i = o.target) == null ? void 0 : i.getView();
              a == null || a.toggleLightbox();
            }
          }
        ],
        styles: `
      ...
      onSourceTypeChange(t, o, a) {
        if (a.adjust) return;
        const b = this.get(p) === "video" ? "video" : "image";
        this.addAttributes({ [G]: b, href: "" });
      },
      adjustSourceType() {
        const t = this.get(p), o = this.getAttributes().href || "", a = { adjust: !0 };
        if (t === "video") {
          const i = o.includes("youtube.com") ? "youtube" : "video";
          this.addAttributes({ [G]: i }, a);
        } else t !== "el" && o.startsWith("#") ? this.set(p, "el", a) : t === "image" && this.addAttributes({ [G]: "image" }, a);
      },
      updateTraits(t = {}) {
        const { changed: o } = this, { init: a } = t;
        if (o[I.name] || a) {
    ...
    view: {
      ...
      toggleLightbox() {
        var L;
        const { em: t, el: o, model: a } = this, { Canvas: i } = t, b = a.getAttributes()[D], { defaultView: d, documentElement: k } = o.ownerDocument, R = (L = d.fsLightboxInstances) == null ? void 0 : L[b];
        if (k.classList.contains(oe))
          R.close();
        else {
          o.__skipLb = !1;
          let x;
