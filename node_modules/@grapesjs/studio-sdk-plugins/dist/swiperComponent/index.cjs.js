"use strict";const te="app.grapesjs.com",ae="app-stage.grapesjs.com",le="app2.grapesjs.com",se="app-stage2.grapesjs.com",U=[te,le,ae,se,"localhost","127.0.0.1",".local-credentialless.webcontainer.io",".local.webcontainer.io","-sandpack.codesandbox.io"],oe="license:check:end",ie=()=>typeof window<"u",ne=({isDev:e,isStage:l,isPlatform:a})=>`${e?"":`https://${l?ae:te}`}/${a?"platform-api":"api"}`,re=()=>{const e=ie()&&window.location.hostname;return!!e&&(U.includes(e)||U.some(l=>e.endsWith(l)))},ce=e=>e.replace(/[A-Z]+(?![a-z])|[A-Z]/g,(l,a)=>(a?"-":"")+l.toLowerCase()),de=e=>typeof e<"u";async function pe({path:e,baseApiUrl:l,method:a="GET",headers:s={},params:o,body:f}){const d=`${l||ne({isDev:!1,isStage:!1})}${e}`,p={method:a,headers:{"Content-Type":"application/json",...s}};f&&(p.body=JSON.stringify(f));const b=o?new URLSearchParams(o).toString():"",g=b?`?${b}`:"",i=await fetch(`${d}${g}`,p);if(!i.ok)throw new Error(`HTTP error! status: ${i.status}`);return i.json()}var x=(e=>(e.free="free",e.startup="startup",e.business="business",e.enterprise="enterprise",e))(x||{}),q=(e=>(e.toastAdd="studio:toastAdd",e.toastRemove="studio:toastRemove",e.dialogOpen="studio:dialogOpen",e.dialogClose="studio:dialogClose",e.dialogExportCode="studio:dialogExportCode",e.dialogImportCode="studio:dialogImportCode",e.sidebarLeftSet="studio:sidebarLeft:set",e.sidebarLeftGet="studio:sidebarLeft:get",e.sidebarLeftToggle="studio:sidebarLeft:toggle",e.sidebarRightSet="studio:sidebarRight:set",e.sidebarRightGet="studio:sidebarRight:get",e.sidebarRightToggle="studio:sidebarRight:toggle",e.sidebarTopSet="studio:sidebarTop:set",e.sidebarTopGet="studio:sidebarTop:get",e.sidebarTopToggle="studio:sidebarTop:toggle",e.sidebarBottomSet="studio:sidebarBottom:set",e.sidebarBottomGet="studio:sidebarBottom:get",e.sidebarBottomToggle="studio:sidebarBottom:toggle",e.symbolAdd="studio:symbolAdd",e.symbolDetach="studio:symbolDetach",e.symbolOverride="studio:symbolOverride",e.symbolPropagateStyles="studio:propagateStyles",e.getPagesConfig="studio:getPagesConfig",e.setPagesConfig="studio:setPagesConfig",e.getPageSettings="studio:getPageSettings",e.setPageSettings="studio:setPageSettings",e.clearPage="studio:clearPage",e.projectFiles="studio:projectFiles",e.validateCode="studio:validateCode",e.canvasReload="studio:canvasReload",e.getBlocksPanel="studio:getBlocksPanel",e.setBlocksPanel="studio:setBlocksPanel",e.getStateContextMenu="studio:getStateContextMenu",e.setStateContextMenu="studio:setStateContextMenu",e.contextMenuComponent="studio:contextMenuComponent",e.layoutAdd="studio:layoutAdd",e.layoutRemove="studio:layoutRemove",e.layoutToggle="studio:layoutToggle",e.layoutUpdate="studio:layoutUpdate",e.layoutGet="studio:layoutGet",e.layoutConfigGet="studio:layoutConfigGet",e.layoutConfigSet="studio:layoutConfigSet",e.layoutComponentAdd="studio:layoutComponentAdd",e.layoutComponentGet="studio:layoutComponentGet",e.layoutComponentRemove="studio:layoutComponentRemove",e.layoutComponentRender="studio:layoutComponentRender",e.getStateTheme="studio:getStateTheme",e.setStateTheme="studio:setStateTheme",e.settings="studio:settings",e.assetProviderGet="studio:assetProviderGet",e.assetProviderAdd="studio:assetProviderAdd",e.assetProviderRemove="studio:assetProviderRemove",e.fontGet="studio:fontGet",e.fontAdd="studio:fontAdd",e.fontRemove="studio:fontRemove",e.fontManagerOpen="studio:fontManagerOpen",e.menuFontLoad="studio:menuFontLoad",e.toggleStateDataSource="studio:toggleStateDataSource",e.getStateDataSource="studio:getStateDataSource",e.dataSourceSetGlobalData="studio:dataSourceSetGlobalData",e.dataSourceSetImporter="studio:dataSourceSetImporter",e.dataSourceSetExporter="studio:dataSourceSetExporter",e.setDragAbsolute="studio:setDragAbsolute",e))(q||{});const j={[x.free]:0,[x.startup]:10,[x.business]:20,[x.enterprise]:30};function ue(e){const l=e;return l.init=a=>s=>e(s,a),l}const be=e=>ue(e);async function fe({editor:e,plan:l,pluginName:a,licenseKey:s,onLicenseCheckResponse:o,cleanup:f}){let c="",d;const p=i=>{console.warn("Cleanup plugin:",a,"Reason:",i),f()},b=(i={})=>{var _;const{error:t,sdkLicense:n}=i,w=(_=i.plan)==null?void 0:_.category;if(!(n||i.license)||t)p(t||"Invalid license");else if(w){const B=j[l],$=j[w];B>$&&p({pluginRequiredPlan:l,licensePlan:w})}};e.Commands.has(q.settings)&&(d=e.runCommand(q.settings),c=(d==null?void 0:d.baseUrl)||"");const g=i=>{o==null||o(i),i&&b(i)};if(!d){e.onReady(async()=>{if(!re())if(s){const i=await he({licenseKey:s,pluginName:a,baseApiUrl:c});g(i)}else p("The `licenseKey` option not provided")});return}if(d.licensePlan||d.licenseError){const i=ge(d);g(i);return}e.on(oe,i=>g(i))}const ge=e=>({sdkLicense:e.license,license:e.license,error:e.licenseError,plan:e.licensePlan});async function he(e){const{licenseKey:l,pluginName:a,baseApiUrl:s}=e;try{return(await pe({baseApiUrl:s,path:`/sdk/${l||"na"}`,method:"POST",params:{d:window.location.hostname,pn:a}})).result||{}}catch(o){return console.error("Error during SDK license check:",o),!1}}const E=(e,l)=>{var a;return!!((a=e==null?void 0:e.classList)!=null&&a.contains(l))},ve=(e,l={})=>{var f;const a={},s=[],o=[];for(const c in e){const{value:d,...p}=e[c];s.push({id:c,name:c,changeProp:!0,category:l.category,...p}),a[c]=d,!de(d)&&o.push(c);const{subTraits:b={}}=p;for(const g in p.subTraits)(f=b[g])==null||f.forEach(i=>{const t=i.id||i.name;a[t]=i.value})}return{propKeys:Object.keys(a),propsNoValues:o,props:a,traits:s}},ye=(e,l)=>{l.forEach(a=>{if(a.subTraits){const s=`${a.id||a.name}`,o=a.changeProp?`change:${s}`:`change:attributes:${s}`;e.on(o,()=>Z(e,s)),Z(e,s)}})},Z=(e,l)=>{const a=e.getTrait(l),s=a.get("category"),o=a.get("subTraits")||{},c=(Object.values(o).flat()||[]).map(b=>b.id||b.name);e.removeTrait(c);const d=o[a.getValue()],p=e.getTraitIndex(l)+1;d&&e.addTrait(d.map(b=>({category:s,...b})),{at:p})},we=(e,l)=>{l.forEach(a=>{const s=ce(a);s!==a&&e.has(s)&&e.set({[a]:e.get(s),[s]:void 0})})},v="swiper",O=`${v}-slide`,L=`${v}-wrapper`,A=`${v}-nav-prev`,I=`${v}-nav-next`,k=`${v}-pagination`,M=`${v}-scrollbar`,u={slider:`<svg viewBox="0 0 24 24">
  ...
  <path d="M12 20a8 8 0 1 1 0-16 8 8 0 0 1 0 16m0-18A10 10 0 0 0 2 12a10 10 0 0 0 10 10 10 10 0 0 0 10-10A10 10 0 0 0 12 2m1 5h-2v4H7v2h4v4h2v-4h4v-2h-4V7Z"/>
        ...
        `}}}),l.addType(I,{extend:A,isComponent:s=>E(s,V),model:{defaults:{name:Ee,classes:V,components:a("M27,22L27,22L5,44l-2.1-2.1L22.8,22L2.9,2.1L5,0L27,22L27,22z"),styles:`
          .${V} {
            color: inherit;
          }
          .${V}:after {
        ...
        `}}}),()=>{l.removeType(A),l.removeType(I)}},xe=e=>{const{Components:l}=e,a=`${R}pagination`;return l.addType(k,{isComponent:s=>E(s,a),model:{defaults:{name:"Pagination",classes:a,copyable:!1,highlightable:!1,droppable:!1,draggable:!1,selectable:!1,hoverable:!1,layerable:!1,styles:`
          .${a}-bullet-active {
        ...
        `}}}),()=>{l.removeType(k)}},Le="Scrollbar",J=`${R}scrollbar`,Ae=e=>{const{Components:l}=e;return l.addType(M,{isComponent:a=>E(a,J),model:{defaults:{name:Le,classes:J,copyable:!1,highlightable:!1,removable:!1,selectable:!1,hoverable:!1,layerable:!1,droppable:!1,draggable:!1}}}),()=>{l.removeType(M)}},ke="Slide",Q=`${R}slide`,Re=e=>{const{Components:l}=e;return l.addType(O,{isComponent:a=>E(a,Q),model:{defaults:{name:ke,classes:Q,icon:u.slider,draggable:(a,s)=>s.is(L)}}}),()=>{l.removeType(O)}},Ne="Wrapper",ee=`${R}wrapper`,_e=e=>{const{Components:l}=e,{events:a}=l;return l.addType(L,{isComponent:s=>E(s,ee),model:{defaults:{name:Ne,icon:u.slider,classes:ee,copyable:!1,removable:!1,draggable:!1,highlightable:!1,droppable:s=>s.is(O)},init(){const s=this.components();this.listenTo(s,"add remove",this.updateSlider)},updateSlider(s){const o=this.closestType(v);if(o){const f=o.getView();o.reloadSlider(),this.em.once(a.scriptMount,()=>{setTimeout(()=>{var c;return(c=f.getSwiper())==null?void 0:c.slideTo(s.index())},100)})}}}}),()=>{l.removeType(L)}},Me="swiperComponent",Oe=x.startup,Be=function(e,l={}){const a={block:{},cdnScript:"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js",cdnStyle:"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css",...l},s=[Se(e,a),Te(e),_e(e),Re(e),xe(e),Ae(e)];fe({editor:e,plan:Oe,licenseKey:a.licenseKey,pluginName:Me,cleanup:()=>{s.forEach(o=>o())}})},De=be(Be);module.exports=De;
