"use strict";const L="app.grapesjs.com",H="app-stage.grapesjs.com",k="app2.grapesjs.com",G="app-stage2.grapesjs.com",z=[L,k,H,G,"localhost","127.0.0.1",".local-credentialless.webcontainer.io",".local.webcontainer.io","-sandpack.codesandbox.io"],E="license:check:end",I=()=>typeof window<"u",O=({isDev:e,isStage:a,isPlatform:i})=>`${e?"":`https://${a?H:L}`}/${i?"platform-api":"api"}`,F=()=>{const e=I()&&window.location.hostname;return!!e&&(z.includes(e)||z.some(a=>e.endsWith(a)))};async function N({path:e,baseApiUrl:a,method:i="GET",headers:c={},params:n,body:r}){const o=`${a||O({isDev:!1,isStage:!1})}${e}`,t={method:i,headers:{"Content-Type":"application/json",...c}};r&&(t.body=JSON.stringify(r));const g=n?new URLSearchParams(n).toString():"",h=g?`?${g}`:"",l=await fetch(`${o}${h}`,t);if(!l.ok)throw new Error(`HTTP error! status: ${l.status}`);return l.json()}var y=(e=>(e.free="free",e.startup="startup",e.business="business",e.enterprise="enterprise",e))(y||{}),V=(e=>(e.toastAdd="studio:toastAdd",e.toastRemove="studio:toastRemove",e.dialogOpen="studio:dialogOpen",e.dialogClose="studio:dialogClose",e.dialogExportCode="studio:dialogExportCode",e.dialogImportCode="studio:dialogImportCode",e.sidebarLeftSet="studio:sidebarLeft:set",e.sidebarLeftGet="studio:sidebarLeft:get",e.sidebarLeftToggle="studio:sidebarLeft:toggle",e.sidebarRightSet="studio:sidebarRight:set",e.sidebarRightGet="studio:sidebarRight:get",e.sidebarRightToggle="studio:sidebarRight:toggle",e.sidebarTopSet="studio:sidebarTop:set",e.sidebarTopGet="studio:sidebarTop:get",e.sidebarTopToggle="studio:sidebarTop:toggle",e.sidebarBottomSet="studio:sidebarBottom:set",e.sidebarBottomGet="studio:sidebarBottom:get",e.sidebarBottomToggle="studio:sidebarBottom:toggle",e.symbolAdd="studio:symbolAdd",e.symbolDetach="studio:symbolDetach",e.symbolOverride="studio:symbolOverride",e.symbolPropagateStyles="studio:propagateStyles",e.getPagesConfig="studio:getPagesConfig",e.setPagesConfig="studio:setPagesConfig",e.getPageSettings="studio:getPageSettings",e.setPageSettings="studio:setPageSettings",e.clearPage="studio:clearPage",e.projectFiles="studio:projectFiles",e.validateCode="studio:validateCode",e.canvasReload="studio:canvasReload",e.getBlocksPanel="studio:getBlocksPanel",e.setBlocksPanel="studio:setBlocksPanel",e.getStateContextMenu="studio:getStateContextMenu",e.setStateContextMenu="studio:setStateContextMenu",e.contextMenuComponent="studio:contextMenuComponent",e.layoutAdd="studio:layoutAdd",e.layoutRemove="studio:layoutRemove",e.layoutToggle="studio:layoutToggle",e.layoutUpdate="studio:layoutUpdate",e.layoutGet="studio:layoutGet",e.layoutConfigGet="studio:layoutConfigGet",e.layoutConfigSet="studio:layoutConfigSet",e.layoutComponentAdd="studio:layoutComponentAdd",e.layoutComponentGet="studio:layoutComponentGet",e.layoutComponentRemove="studio:layoutComponentRemove",e.layoutComponentRender="studio:layoutComponentRender",e.getStateTheme="studio:getStateTheme",e.setStateTheme="studio:setStateTheme",e.settings="studio:settings",e.assetProviderGet="studio:assetProviderGet",e.assetProviderAdd="studio:assetProviderAdd",e.assetProviderRemove="studio:assetProviderRemove",e.fontGet="studio:fontGet",e.fontAdd="studio:fontAdd",e.fontRemove="studio:fontRemove",e.fontManagerOpen="studio:fontManagerOpen",e.menuFontLoad="studio:menuFontLoad",e.toggleStateDataSource="studio:toggleStateDataSource",e.getStateDataSource="studio:getStateDataSource",e.dataSourceSetGlobalData="studio:dataSourceSetGlobalData",e.dataSourceSetImporter="studio:dataSourceSetImporter",e.dataSourceSetExporter="studio:dataSourceSetExporter",e.setDragAbsolute="studio:setDragAbsolute",e))(V||{});const T={[y.free]:0,[y.startup]:10,[y.business]:20,[y.enterprise]:30};function U(e){const a=e;return a.init=i=>c=>e(c,i),a}const C=e=>U(e);async function W({editor:e,plan:a,pluginName:i,licenseKey:c,onLicenseCheckResponse:n,cleanup:r}){let p="",o;const t=l=>{console.warn("Cleanup plugin:",i,"Reason:",l),r()},g=(l={})=>{var w;const{error:A,sdkLicense:b}=l,u=(w=l.plan)==null?void 0:w.category;if(!(b||l.license)||A)t(A||"Invalid license");else if(u){const R=T[a],x=T[u];R>x&&t({pluginRequiredPlan:a,licensePlan:u})}};e.Commands.has(V.settings)&&(o=e.runCommand(V.settings),p=(o==null?void 0:o.baseUrl)||"");const h=l=>{n==null||n(l),l&&g(l)};if(!o){e.onReady(async()=>{if(!F())if(c){const l=await j({licenseKey:c,pluginName:i,baseApiUrl:p});h(l)}else t("The `licenseKey` option not provided")});return}if(o.licensePlan||o.licenseError){const l=_(o);h(l);return}e.on(E,l=>h(l))}const _=e=>({sdkLicense:e.license,license:e.license,error:e.licenseError,plan:e.licensePlan});async function j(e){const{licenseKey:a,pluginName:i,baseApiUrl:c}=e;try{return(await N({baseApiUrl:c,path:`/sdk/${a||"na"}`,method:"POST",params:{d:window.location.hostname,pn:i}})).result||{}}catch(n){return console.error("Error during SDK license check:",n),!1}}const Y=(e,a)=>{var i;return!!((i=e==null?void 0:e.classList)!=null&&i.contains(a))},P=e=>a=>{var i;return((i=a.getAttribute)==null?void 0:i.call(a,$))===e},B="gjs-plg-",$="data-type-role",K="shapeDividerComponent",X=y.startup,Z=function(e,a={}){const{Components:i,Blocks:c,Selectors:n}=e,r="shape-divider",p=`${r}-cnt`,o=`${B}${r}`,t=`${B}${p}`,g=[{id:"tilt",label:"Tilt",value:`<svg preserveAspectRatio="none" viewBox="0 0 240 24">
          ...
          </svg>`}],h={tl:!1,tc:!1,tr:!1,cl:!1,cr:!1,bl:!1,bc:!1,br:!1},l={...h,bc:!0},A={...h,tc:!0},b="shape",u="flip-y",M="flip-x",w="Shape Divider",R=`<svg viewBox="0 0 22 22">
        <path fill="currentColor" d="M2 2v18h18V2H2zm0-2h18a2 2 0 012 2v18a2 2 0 01-2 2H2a2 2 0 01-2-2V2C0 .9.9 0 2 0zM1 13L2 0h18l1 9-20 4z"/>
      </svg>`,{block:x={}}=a;e.on(n.events.add,s=>{s.getFullName().startsWith(`.${o}`)&&s.set({private:!0})}),i.addType(r,{isComponent:s=>P(r)(s)||Y(s,o),block:x&&{label:w,media:R,category:"Extra",select:!0,...x},model:{defaults:{droppable:!1,highlightable:!1,classes:o,attributes:{[$]:r},components:{type:p},styles:`.${o} { position: relative; }`,delegate:{select:s=>s.findFirstType(p),layer:s=>s.findFirstType(p)}}},view:{onRender(){this.el.style.height="1px"}}}),i.addType(p,{isComponent:P(p),model:{defaults:{droppable:!1,highlightable:!1,classes:t,emptyState:!0,icon:R,name:w,delegate:{remove:s=>s.parent(),move:s=>s.parent(),copy:s=>s.parent()},attributes:{[$]:p},[b]:g[0].id,resizable:l,stylable:["height","width","color"],styles:`
          .${t} {
              position: absolute;
              width: 100%;
              height: 100px;
          ...
          `,traits:[{type:"select",name:b,label:"Shape",changeProp:!0,options:g.map(({id:s,label:d,value:v})=>({id:s,label:d,icon:{icon:v.replace("<svg ",'<svg style="width: 35px; height: 7px; fill: currentColor;"')}}))},{type:"checkbox",name:u,label:"Flip vertically",changeProp:!0},{type:"checkbox",name:M,label:"flip horizontally",changeProp:!0}]},init(){this.on(`change:${b}`,this.onShapeChange),this.on(`change:${M} change:${u}`,this.onFlip),this.onShapeChange()},onShapeChange(){const s=this.get(b),d=g.find(f=>f.id===s),v=(d==null?void 0:d.value)||this.getInnerHTML().trim();this.components(""),v&&this.set("content",v)},onFlip(){const s=this.get(u),d=this.get(M),v=["fl-v","fl-h","fl-v-h"].map(D=>`${t}--${D}`);let f;s&&d?f=v[2]:d?f=v[1]:s&&(f=v[0]),this.removeClass(v),f&&this.addClass(f),this.set("resizable",s?A:l)}}}),W({editor:e,licenseKey:a.licenseKey,plan:X,pluginName:K,cleanup:()=>{i.removeType(r),c.remove(r)}})},q=C(Z);module.exports=q;
