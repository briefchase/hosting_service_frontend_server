(function(b,y){typeof exports=="object"&&typeof module<"u"?module.exports=y():typeof define=="function"&&define.amd?define(y):(b=typeof globalThis<"u"?globalThis:b||self,b.StudioSdkPlugins_shapeDividerComponent=y())})(this,function(){"use strict";const b="app.grapesjs.com",y="app-stage.grapesjs.com",z=[b,"app2.grapesjs.com",y,"app-stage2.grapesjs.com","localhost","127.0.0.1",".local-credentialless.webcontainer.io",".local.webcontainer.io","-sandpack.codesandbox.io"],H="license:check:end",k=()=>typeof window<"u",G=({isDev:e,isStage:a,isPlatform:l})=>`${e?"":`https://${a?y:b}`}/${l?"platform-api":"api"}`,I=()=>{const e=k()&&window.location.hostname;return!!e&&(z.includes(e)||z.some(a=>e.endsWith(a)))};async function E({path:e,baseApiUrl:a,method:l="GET",headers:p={},params:n,body:r}){const o=`${a||G({isDev:!1,isStage:!1})}${e}`,t={method:l,headers:{"Content-Type":"application/json",...p}};r&&(t.body=JSON.stringify(r));const g=n?new URLSearchParams(n).toString():"",h=g?`?${g}`:"",i=await fetch(`${o}${h}`,t);if(!i.ok)throw new Error(`HTTP error! status: ${i.status}`);return i.json()}var w=(e=>(e.free="free",e.startup="startup",e.business="business",e.enterprise="enterprise",e))(w||{}),$=(e=>(e.toastAdd="studio:toastAdd",e.toastRemove="studio:toastRemove",e.dialogOpen="studio:dialogOpen",e.dialogClose="studio:dialogClose",e.dialogExportCode="studio:dialogExportCode",e.dialogImportCode="studio:dialogImportCode",e.sidebarLeftSet="studio:sidebarLeft:set",e.sidebarLeftGet="studio:sidebarLeft:get",e.sidebarLeftToggle="studio:sidebarLeft:toggle",e.sidebarRightSet="studio:sidebarRight:set",e.sidebarRightGet="studio:sidebarRight:get",e.sidebarRightToggle="studio:sidebarRight:toggle",e.sidebarTopSet="studio:sidebarTop:set",e.sidebarTopGet="studio:sidebarTop:get",e.sidebarTopToggle="studio:sidebarTop:toggle",e.sidebarBottomSet="studio:sidebarBottom:set",e.sidebarBottomGet="studio:sidebarBottom:get",e.sidebarBottomToggle="studio:sidebarBottom:toggle",e.symbolAdd="studio:symbolAdd",e.symbolDetach="studio:symbolDetach",e.symbolOverride="studio:symbolOverride",e.symbolPropagateStyles="studio:propagateStyles",e.getPagesConfig="studio:getPagesConfig",e.setPagesConfig="studio:setPagesConfig",e.getPageSettings="studio:getPageSettings",e.setPageSettings="studio:setPageSettings",e.clearPage="studio:clearPage",e.projectFiles="studio:projectFiles",e.validateCode="studio:validateCode",e.canvasReload="studio:canvasReload",e.getBlocksPanel="studio:getBlocksPanel",e.setBlocksPanel="studio:setBlocksPanel",e.getStateContextMenu="studio:getStateContextMenu",e.setStateContextMenu="studio:setStateContextMenu",e.contextMenuComponent="studio:contextMenuComponent",e.layoutAdd="studio:layoutAdd",e.layoutRemove="studio:layoutRemove",e.layoutToggle="studio:layoutToggle",e.layoutUpdate="studio:layoutUpdate",e.layoutGet="studio:layoutGet",e.layoutConfigGet="studio:layoutConfigGet",e.layoutConfigSet="studio:layoutConfigSet",e.layoutComponentAdd="studio:layoutComponentAdd",e.layoutComponentGet="studio:layoutComponentGet",e.layoutComponentRemove="studio:layoutComponentRemove",e.layoutComponentRender="studio:layoutComponentRender",e.getStateTheme="studio:getStateTheme",e.setStateTheme="studio:setStateTheme",e.settings="studio:settings",e.assetProviderGet="studio:assetProviderGet",e.assetProviderAdd="studio:assetProviderAdd",e.assetProviderRemove="studio:assetProviderRemove",e.fontGet="studio:fontGet",e.fontAdd="studio:fontAdd",e.fontRemove="studio:fontRemove",e.fontManagerOpen="studio:fontManagerOpen",e.menuFontLoad="studio:menuFontLoad",e.toggleStateDataSource="studio:toggleStateDataSource",e.getStateDataSource="studio:getStateDataSource",e.dataSourceSetGlobalData="studio:dataSourceSetGlobalData",e.dataSourceSetImporter="studio:dataSourceSetImporter",e.dataSourceSetExporter="studio:dataSourceSetExporter",e.setDragAbsolute="studio:setDragAbsolute",e))($||{});const B={[w.free]:0,[w.startup]:10,[w.business]:20,[w.enterprise]:30};function O(e){const a=e;return a.init=l=>p=>e(p,l),a}const N=e=>O(e);async function F({editor:e,plan:a,pluginName:l,licenseKey:p,onLicenseCheckResponse:n,cleanup:r}){let c="",o;const t=i=>{console.warn("Cleanup plugin:",l,"Reason:",i),r()},g=(i={})=>{var M;const{error:R,sdkLicense:A}=i,u=(M=i.plan)==null?void 0:M.category;if(!(A||i.license)||R)t(R||"Invalid license");else if(u){const T=B[a],V=B[u];T>V&&t({pluginRequiredPlan:a,licensePlan:u})}};e.Commands.has($.settings)&&(o=e.runCommand($.settings),c=(o==null?void 0:o.baseUrl)||"");const h=i=>{n==null||n(i),i&&g(i)};if(!o){e.onReady(async()=>{if(!I())if(p){const i=await C({licenseKey:p,pluginName:l,baseApiUrl:c});h(i)}else t("The `licenseKey` option not provided")});return}if(o.licensePlan||o.licenseError){const i=_(o);h(i);return}e.on(H,i=>h(i))}const _=e=>({sdkLicense:e.license,license:e.license,error:e.licenseError,plan:e.licensePlan});async function C(e){const{licenseKey:a,pluginName:l,baseApiUrl:p}=e;try{return(await E({baseApiUrl:p,path:`/sdk/${a||"na"}`,method:"POST",params:{d:window.location.hostname,pn:l}})).result||{}}catch(n){return console.error("Error during SDK license check:",n),!1}}const U=(e,a)=>{var l;return!!((l=e==null?void 0:e.classList)!=null&&l.contains(a))},L=e=>a=>{var l;return((l=a.getAttribute)==null?void 0:l.call(a,P))===e},D="gjs-plg-",P="data-type-role",W="shapeDividerComponent",j=w.startup;return N(function(e,a={}){const{Components:l,Blocks:p,Selectors:n}=e,r="shape-divider",c=`${r}-cnt`,o=`${D}${r}`,t=`${D}${c}`,g=[{id:"tilt",label:"Tilt",value:`<svg preserveAspectRatio="none" viewBox="0 0 240 24">
      ...
      </svg>`,{block:V={}}=a;e.on(n.events.add,s=>{s.getFullName().startsWith(`.${o}`)&&s.set({private:!0})}),l.addType(r,{isComponent:s=>L(r)(s)||U(s,o),block:V&&{label:M,media:T,category:"Extra",select:!0,...V},model:{defaults:{droppable:!1,highlightable:!1,classes:o,attributes:{[P]:r},components:{type:c},styles:`.${o} { position: relative; }`,delegate:{select:s=>s.findFirstType(c),layer:s=>s.findFirstType(c)}}},view:{onRender(){this.el.style.height="1px"}}}),l.addType(c,{isComponent:L(c),model:{defaults:{droppable:!1,highlightable:!1,classes:t,emptyState:!0,icon:T,name:M,delegate:{remove:s=>s.parent(),move:s=>s.parent(),copy:s=>s.parent()},attributes:{[P]:c},[A]:g[0].id,resizable:i,stylable:["height","width","color"],styles:`
          .${t} {
              position: absolute;
              width: 100%;
              height: 100px;
